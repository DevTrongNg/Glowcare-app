            ...
            <div className="flex flex-col lg:gap-y-[33px] mb:gap-y-6 border rounded-xl lg:p-8 mb:p-6">
              ...
              <div className="flex flex-col gap-y-[17px] lg:mt-0.5">
                ...
                <p className="text-[14px] text-[#717378] leading-[21px]">
                  Contrary to the deep all-body relaxation that comes with the
                  use of indica strains, sativas are known for increasing the
                  feeling of creativity, enhancing focus and lessening anxiety.
                  This is more of a mind-centered high in terms of how and where
                  you will feel the effects. Given its stimulating nature, it is
            ...
            <div className="flex flex-col lg:gap-y-[33px] mb:gap-y-[26px] border rounded-xl lg:p-8 mb:p-6">
              ...
              <div className="flex flex-col gap-y-[17px] lg:mt-0.5">
                ...
                <p className="text-[14px] tracking-[-0.01px] text-[#717378] leading-[21px]">
                  ...
                  and worries while also clearing the mind ready to focus fresh
                  on something new. Hybrids are expertly tailored to result in
                  ...
                  (boosting creativity, increasing mood and lessening anxiety)
                  and balanced (the best of both worlds).
                </p>
              </div>
              <a className="lg:text-base text-[#17AF26] mb:text-sm underline tracking-[-0.5px]">
                Shop Indica
